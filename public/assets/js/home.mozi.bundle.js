...
/***/ function(module, exports, __webpack_require__) {
	...
	var _abstract = __webpack_require__(337);

	var _abstract2 = _interopRequireDefault(_abstract);

	var _timestamp2date = __webpack_require__(292);

	var _timestamp2date2 = _interopRequireDefault(_timestamp2date);

	var _friendlyTime = __webpack_require__(352);

	var _friendlyTime2 = _interopRequireDefault(_friendlyTime);

	var _newLine = __webpack_require__(353);

	var _newLine2 = _interopRequireDefault(_newLine);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var FastClick = __webpack_require__(354); /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sign = __webpack_require__(295);

	var _sign2 = _interopRequireDefault(_sign);

	var _activityTimeline = __webpack_require__(304);

	var _activityTimeline2 = _interopRequireDefault(_activityTimeline);

	var _UpdateChildInfo = __webpack_require__(285);

	var _UpdateChildInfo2 = _interopRequireDefault(_UpdateChildInfo);

	var _userInfoModify = __webpack_require__(312);
	...
	var _comment = __webpack_require__(321);
	...
	var _share = __webpack_require__(333);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		API_GET_RULE: function API_GET_RULE() {
			return _resourse.activityRuleResource.get();
		},

		API_GET_USER_SIGN: function API_GET_USER_SIGN(acitivity_id, sign_id) {
			return _resourse.UserSignResource.get({ activity_id: acitivity_id, signin_id: sign_id });
		},

		API_SHARE_SUCCESS: function API_SHARE_SUCCESS() {
			return _resourse.shareResource.get();
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var activityRuleResource = exports.activityRuleResource = _vue2.default.resource(API_ROOT + '/api/signin/score_rule'); //积分规则
	var UserSignResource = exports.UserSignResource = _vue2.default.resource(API_ROOT + '/api/signin/user/show_signin/{activity_id}/{signin_id}'); //获取单个签到信息
	var shareResource = exports.shareResource = _vue2.default.resource(API_ROOT + 'api/signin/user/mysignin_share'); //添加
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		getActivityRule: function getActivityRule() {
			return _activity2.default.API_GET_RULE();
		},

		getSign: function getSign(activity_id, sign_id, callback) {
			return _activity2.default.API_GET_USER_SIGN(activity_id, sign_id).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shareLayer = __webpack_require__(191);

	var _shareLayer2 = _interopRequireDefault(_shareLayer);

	var _weixinService = __webpack_require__(199);

	var _userGetter = __webpack_require__(205);
	...
	exports.default = {
		...
		methods: {
			...
			share: function share() {
				...
				(0, _weixinService.share)(this.user.user_name + '参加了活动:' + this.activityInfo.info.title, this.activityInfo.info.desc, (0, _weixinService.getAuthUrl)(_config2.default.domain + '/#!' + this.$route.path.split('?')[0]), this.activityInfo.info.sponsor_avatar);
			}
		},
		computed: {
				...
				_activityService2.default.sign(this.id, this.url, this.content).then(function (data) {
					...
					if (info.result === 0) {
						...
						_self.$dispatch('confirm', '打卡成功', '是否分享给小伙伴', function () {
							...
							(0, _weixinService.share)(info.info.user_name + '在漠子打卡完成了:' + info.info.activity_title, info.info.activity_desc, (0, _weixinService.getAuthUrl)(_config2.default.domain + '/#!/sign/' + info.info.activity_id + '/' + info.info.signin_id), info.info.image_url);
						});
					} else {
						_self.$dispatch('loading');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/layer/shareLayer.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5ee0cc87/shareLayer.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _layer = __webpack_require__(194);
	...
	// 			</p>
	//
	// 			<button class="mz-button-transparent" @click="onHide">知道了</button>
	// 	</layer>
	// </template>
	//
	// <style>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/layer/layer.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getAuthUrl = exports.share = exports.shareAppMessage = exports.shareTimeline = exports.jssdkConfigInit = undefined;
	...
	var jssdkConfigInit = exports.jssdkConfigInit = function jssdkConfigInit(debug, jsApiList, callback) {
	...
	var shareTimeline = exports.shareTimeline = function shareTimeline(title, desc, link, imgUrl, _success, _cancel) {
		window.wx.onMenuShareTimeline({
			...
			success: function success() {
				_activity2.default.API_SHARE_SUCCESS();
				_success();
			},
	 ...
	 * @param cancel
	 */
	var shareAppMessage = exports.shareAppMessage = function shareAppMessage(title, desc, link, imgUrl, _success2, _cancel2) {
		window.wx.onMenuShareAppMessage({
			...
			success: function success() {
				_activity2.default.API_SHARE_SUCCESS();
				if (typeof _success2 === 'function') _success2();
			},
			cancel: function cancel() {
				if (typeof _cancel2 === 'function') _cancel2();
			}
		});
	};

	var share = exports.share = function share(title, desc, link, imgUrl, success, cancel) {
		shareAppMessage(title, desc, link, imgUrl, success, cancel);
		shareTimeline(title, desc, link, imgUrl, success, cancel);
	};

	var getAuthUrl = exports.getAuthUrl = function getAuthUrl(url) {
		return 'https://open.weixin.qq.com/connect/oauth2/authorize?' + 'appid=' + _config2.default.appid + '&redirect_uri=' + encodeURIComponent(url) + '&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardWithoutAvatar = __webpack_require__(260);

	var _cardWithoutAvatar2 = _interopRequireDefault(_cardWithoutAvatar);

	var _awardDialog = __webpack_require__(264);
	...
	exports.default = {
		...
		methods: {
			...
			getRule: function getRule() {
				var _self = this;
				_activityService2.default.getActivityRule().then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(70)(IteratorPrototype, __webpack_require__(239)('iterator'), function(){ return this; });
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(239)('species')] = function(exec){ exec(empty, empty); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _groupTitle = __webpack_require__(274);
	...
	var _cardCenterContent = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userService = __webpack_require__(283);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index13 = __webpack_require__(291);

	var _index14 = _interopRequireDefault(_index13);

	var _index15 = __webpack_require__(278);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timeline = __webpack_require__(307);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index11 = __webpack_require__(315);
	...
	var _value2name = __webpack_require__(317);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var find = __webpack_require__(319);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentList = __webpack_require__(324);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/views/share/share.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
		...
		methods: {
			...
			getData: function getData() {
				...
				this.$refs.loader.OnLoading();
				_activityService2.default.getSign(this.activityId, this.signId, function (err, data) {
					if (err === null) {
						_self.$refs.loader.OnHide();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index5 = __webpack_require__(340);

	var _index6 = _interopRequireDefault(_index5);

	var _tips = __webpack_require__(341);
	...
	var _masker = __webpack_require__(350);
	...
	exports.default = {
		...
		ready: function ready() {
			(0, _weixinService.jssdkConfigInit)(false, ['uploadImage', 'chooseImage', 'previewImage', 'onMenuShareTimeline', 'onMenuShareAppMessage'], function () {
				(0, _weixinService.share)('漠子打卡', '天天打卡，积分领不停！', '', 'http://ww4.sinaimg.cn/small/006tNc79gw1f74mcjfukij30hs0hs3zq.jpg');
			});
			this.userUpInfoQuery();
			var subscribe = _reactCookie2.default.load('Subscribe');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toast = __webpack_require__(344);
