...
/***/ function(module, exports, __webpack_require__) {
	...
	var _abstract = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mysign = __webpack_require__(64);

	var _mysign2 = _interopRequireDefault(_mysign);

	var _billboard = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <template>
	// 	<card type="success">
	// 		<avatar-item :avatar-url="avatar" v-link="{name:'book',params:{id:id}}">
	// 			<h4>{{title}}</h4>
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getActivityInfo() {
		console.log(_store2.default.state.activity.activity);
	...
	function getSignUp() {
		return _store2.default.state.activity.signup;
	}

	function postSignIn() {
		return _store2.default.state.activity.signin;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationType = __webpack_require__(62);
	...
	var mutations = (_mutations = {}, (0, _defineProperty3.default)(_mutations, _mutationType.GET_ACTIVITY_LIST, function (state, list) {
		state.activitylist = list.data.list;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.GET_ACTIVITY_INFO, function (state, activity) {
		state.activity = activity.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.GET_SIGN_LIST, function (state, signlist) {
		state.signlist = signlist.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.GET_SIGN_UP, function (state, signup) {
		state.signup = signup.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.POST_SIGN_IN, function (state, signin) {
		state.signin = signin.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.GET_AGREE, function (state, agree) {
		state.agree = agree.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.POST_MESSAGE, function (state, message) {
		state.message = message.data;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.GET_MESSAGE_LIST, function (state, messagelist) {
...
/***/ function(module, exports) {
	...
	var GET_SIGN_LIST = exports.GET_SIGN_LIST = 'GET_SIGN_LIST';
	var GET_SIGN_UP = exports.GET_SIGN_UP = 'GET_SIGN_UP';
	var POST_SIGN_IN = exports.POST_SIGN_IN = 'POST_SIGN_IN';
	var GET_AGREE = exports.GET_AGREE = 'GET_AGREE';
	var POST_MESSAGE = exports.POST_MESSAGE = 'POST_MESSAGE';
	var GET_MESSAGE_LIST = exports.GET_MESSAGE_LIST = 'GET_MESSAGE_LIST';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signCard = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardLabel = __webpack_require__(69);

	var _cardLabel2 = _interopRequireDefault(_cardLabel);

	var _commentItem = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contentWithTitle = __webpack_require__(90);
	...
	var _cardWithAvatar = __webpack_require__(94);
	...
	var _footerButton = __webpack_require__(102);

	var _footerButton2 = _interopRequireDefault(_footerButton);

	var _confirm = __webpack_require__(106);

	var _confirm2 = _interopRequireDefault(_confirm);

	var _activityAction = __webpack_require__(111);
	...
	exports.default = {
		...
		vuex: {
			getters: {
				uf: _activityGetter.getActivityInfo
			},
			actions: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boxWithBorder = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.messageListQuery = exports.messageQuery = exports.agreeQuery = exports.signInQuery = exports.signUpQuery = exports.signListQuery = exports.activityQuery = exports.activityListQuery = undefined;

	var _activity = __webpack_require__(112);
	...
	var signListQuery = exports.signListQuery = function signListQuery(_ref3, id) {
	...
	var signUpQuery = exports.signUpQuery = function signUpQuery(_ref4, id) {
		var dispatch = _ref4.dispatch;

		return _activity2.default.API_GET_SIGN_UP(id).then(function (data) {
			dispatch(types.GET_SIGN_UP, data);
		});
	};

	var signInQuery = exports.signInQuery = function signInQuery(_ref5, id) {
		var dispatch = _ref5.dispatch;

		return _activity2.default.API_POST_SIGN(id).then(function (data) {
			dispatch(types.POST_SIGN_IN, data);
		});
	};

	var agreeQuery = exports.agreeQuery = function agreeQuery(_ref6, id, signin_id) {
		var dispatch = _ref6.dispatch;

		return _activity2.default.API_GET_AGREE(id, signin_id).then(function (data) {
			dispatch(types.GET_AGREE, data);
		});
	};

	var messageQuery = exports.messageQuery = function messageQuery(_ref7, id, signin_id) {
		var dispatch = _ref7.dispatch;

		return _activity2.default.API_POST_MESSAGE(id, signin_id).then(function (data) {
			dispatch(types.POST_MESSAGE, data);
		});
	};

	var messageListQuery = exports.messageListQuery = function messageListQuery(_ref8, id, signin_id) {
		var dispatch = _ref8.dispatch;

		return _activity2.default.API_GET_MESSAGE_LIST(id, signin_id).then(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resourse = __webpack_require__(113);
	...
	exports.default = {
		...
		API_GET_ACTIVITY: function API_GET_ACTIVITY(id) {
			return _resourse.activityResource.get({ id: id });
		},

		API_GET_SIGN_LIST: function API_GET_SIGN_LIST(id) {
			return _resourse.signListResource.get({ id: id });
		},

		API_GET_SIGN_UP: function API_GET_SIGN_UP(id) {
			return _resourse.signUpResource.get({ id: id });
		},

		API_POST_SIGN: function API_POST_SIGN(id) {
			return _resourse.signResource.save({ id: id });
		},

		API_GET_AGREE: function API_GET_AGREE(activity_id, signin_id) {
			return _resourse.agreeResource.get({ activity_id: id, signin_id: signin_id });
		},

		API_POST_MESSAGE: function API_POST_MESSAGE(activity_id, signin_id) {
			return _resourse.messageResource.save({ activity_id: id, signin_id: signin_id });
		},

		API_GET_MESSAGE_LIST: function API_GET_MESSAGE_LIST(activity_id, signin_id) {
			return _resourse.messageListResource.get({ activity_id: id, signin_id: signin_id });
		}
	}; /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.messageListResource = exports.messageResource = exports.agreeResource = exports.signResource = exports.signUpResource = exports.signListResource = exports.activityResource = exports.activityListResource = undefined;

	var _vue = __webpack_require__(1);

	var _vue2 = _interopRequireDefault(_vue);

	var _reactCookie = __webpack_require__(114);
	...
	var VueResource = __webpack_require__(116);
	...
	var activityListResource = exports.activityListResource = _vue2.default.resource('/api/signin/activity/list'); //近期活动列表
	var activityResource = exports.activityResource = _vue2.default.resource('/api/signin/activity/{id}'); //单个活动信息
	var signListResource = exports.signListResource = _vue2.default.resource('/api/signin/activity/{id}/signin_list'); //签到信息列表
	var signUpResource = exports.signUpResource = _vue2.default.resource('/api/signin/activity/{id}/signup'); //报名
	var signResource = exports.signResource = _vue2.default.resource('/api/signin/activity/{id}/signin'); //签到
	var agreeResource = exports.agreeResource = _vue2.default.resource('/api/signin/activity/{activity_id}/{signin_id}/agree'); //点赞
	var messageResource = exports.messageResource = _vue2.default.resource('/api/signin/activity/{activity_id}/{signin_id}/message'); //发表留言
	var messageListResource = exports.messageListResource = _vue2.default.resource('/api/signin/activity/{activity_id}/{signin_id}/message/list'); //获取留言列表
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardWithoutAvatar = __webpack_require__(121);

	var _cardWithoutAvatar2 = _interopRequireDefault(_cardWithoutAvatar);

	var _awardDialog = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _groupTitle = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 		<m-button type="success" large>确认</m-button>
	// 	</div>
	// </template>
	//
	// <style>
